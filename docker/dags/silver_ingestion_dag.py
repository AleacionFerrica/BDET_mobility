...
def silver_mobility_dag():
    ...
    def master_zones():
        ...
        try : 
            con = get_db_connection()
            con.sql(f"CREATE OR REPLACE TABLE  silver.dim_zones AS {query_new_codes} LIMIT 0")
    ...
    task_create_trips >> task_load_trips
    task_load_trips >> task_trips_check
